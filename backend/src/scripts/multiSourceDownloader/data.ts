/**
 * Multi-Source Downloader - Image Source Data
 * 
 * Reliable public domain landmark images organized by continent.
 */

import type { ImageSource } from './types.js';

// Europe
export const EUROPE_IMAGES: ImageSource[] = [
  {
...
// Asia
export const ASIA_IMAGES: ImageSource[] = [
  {
...
// North America
export const NORTH_AMERICA_IMAGES: ImageSource[] = [
  {
...
// South America
export const SOUTH_AMERICA_IMAGES: ImageSource[] = [
  {
...
// Africa
export const AFRICA_IMAGES: ImageSource[] = [
  {
...
// Oceania
export const OCEANIA_IMAGES: ImageSource[] = [
  {
...
// Combined all images
export const PUBLIC_DOMAIN_IMAGES: ImageSource[] = [
  ...EUROPE_IMAGES,
  ...ASIA_IMAGES,
