      ...
      >
        <div className="flex items-center justify-center w-full px-6 py-4 md:py-5">
          ...
          <div className="flex items-center gap-8 md:gap-12">
              ...
              {leftNavLinks.map((item, i) => (
                ...
                >
                  <motion.a
                    ...
                    whileHover={{ y: -1 }}
                    className="group flex items-center gap-1 text-white/60 text-sm font-medium 
            ...
            >
              <span className="text-white font-bold text-lg md:text-xl tracking-[0.12em] leading-none select-none">
                GEOWRAITH
              </span>
            </motion.a>
          ...
          <motion.button
            ...
            className="md:hidden absolute right-6 w-10 h-10 rounded-lg bg-white/5 border border-white/10 
